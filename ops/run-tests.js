...
const SUITES = [
  ...
  { name: '텔레그램 웹훅 (telegram-webhook)', file: 'ops/test-telegram-webhook.js', runner: 'node', expect: 16 },
  ...
  { name: '라우트 인증 (route-auth)', file: 'ops/test-route-auth.js', runner: 'node', expect: 3 },
];
