...
# Entries prefixed with "\b" are matched as whole-word regex patterns;
...
CHALLENGE_MARKERS: list[str] = [
    ...
    "DataDome",
    r"\bcaptcha\b",  # word-boundary: avoids false positives on JS i18n keys like CAPTCHA_TYPE_TEXT
